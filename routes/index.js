...
//Controladores
var idiomasMid     = require('../controllers/idiomas');
...
module.exports = function(passport){
    ...
    router.get('/home', isAuthenticated, idiomasMid.findIdiomas, function(req, res){
        res.render('app/landing/index');
    });
    ...
    router.post('/imprimir', function(req, res) {
         var params = req.body;

        var html = jade.renderFile(root+"/views/documentos/pdf.jade", params);

        console.log(req.body);
        var outputPath = path.normalize(__dirname+'/pdf/'+'recibo.pdf');
        console.log('ruta: '+outputPath);
        return html5pdf({cssPath: root+"/public/stylesheets/pdf.css"}).from.string(html).to(outputPath, function() {
